...
public class TagrisInvalidArnExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private TagrisInvalidArnExceptionUnmarshaller() {
        super(com.amazonaws.services.kinesisfirehose.model.TagrisInvalidArnException.class, "TagrisInvalidArnException");
    }

    @Override
    public com.amazonaws.services.kinesisfirehose.model.TagrisInvalidArnException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.kinesisfirehose.model.TagrisInvalidArnException tagrisInvalidArnException = new com.amazonaws.services.kinesisfirehose.model.TagrisInvalidArnException(
                null);
