...
public class UpdateServerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * For both of these commands, you can replace <i>my-new-server-key</i> with a string of your choice.
     * </p>
     * <important>
     * <p>
     ...
     * 
     * @param hostKey
     *        The RSA or ECDSA private key to use for your server.</p>
     *        <p>
     *        Use the following command to generate an RSA 2048 bit key with no passphrase:
     *        </p>
     *        <p>
     ...
     * </p>
     * 
     * @return The RSA or ECDSA private key to use for your server.</p>
     *         <p>
     *         Use the following command to generate an RSA 2048 bit key with no passphrase:
     *         </p>
     *         <p>
