...
public class FunctionUrlConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public FunctionUrlConfig withAuthorizationType(String authorizationType) {
    ...
    public FunctionUrlConfig withAuthorizationType(AuthorizationType authorizationType) {
    ...
    public String toString() {
        ...
        if (getAuthorizationType() != null)
            sb.append("AuthorizationType: ").append(getAuthorizationType());
        sb.append("}");
        return sb.toString();
    }
